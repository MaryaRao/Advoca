...
<ul class="slides">
	<!-- Slide 1 -->
	<li style="background-image:url(./assets/images/familyban.jpeg);background-size:cover;background-position:center;background-attachment:fixed;position:relative;">
	<div class="overlay-gradient"></div>
		<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			<div class="slider-text-inner">
				<h1 style="font-weight: 600; font-family: sans-serif;">Family Lawyers</h1>
...
<div class="container">
	...
	<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
		...
		<p> law concerns the system of legal rules that define what conduct is classified as a family and how
		the government may prosecute individuals that commit family.</p>
	</div>
</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="lawyerTable">
        ...
        $sql = "SELECT * FROM `lawyerreg` WHERE type = 'family lawyer'";
