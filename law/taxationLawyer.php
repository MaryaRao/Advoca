...
<head>
    ...
    <title>Law &mdash; Family Lawyers</title>
...
<ul class="slides">
	<!-- Slide 1 -->
	<li style="background-image:url(./assets/images/tax.jpg);background-size:cover;background-position:center;background-attachment:fixed;position:relative;height:400px;">
	<div class="overlay-gradient"></div>
		<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			<div class="slider-text-inner">
				<h1 style="font-weight: 600; font-family: sans-serif;">Taxation Lawyers</h1>
...
<section class="div" id="section">
	<div id="fh5co-project">
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Taxation Lawyers</h2>
					<p> law concerns the system of legal rules that define what conduct is classified as a taxation and how
						the government may prosecute individuals that commit taxation.
					</p>
				</div>
			</div>
		</div>
...
<div class="container">
    ...
    <div class="row" id="lawyerTable">
        ...
        $sql = "SELECT * FROM `lawyerreg` WHERE type = 'taxation lawyer'";
