...
<head>
    ...
    <title>Law &mdash; Commercial Lawyers</title>
...
<ul class="slides">
	<!-- Slide 1 -->
	<li style="background-image:url(./assets/images/commban.jpeg);background-size:cover;background-position:center;background-attachment:fixed;position:relative;">
	<div class="overlay-gradient"></div>
		<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			<div class="slider-text-inner">
				<h1 style="font-weight: 600; font-family: sans-serif;">Commercial Lawyers</h1>
...
<div class="container">
	...
	<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
		<h2>Commercial Lawyers</h2>
		<p> law concerns the system of legal rules that define what conduct is classified as a commercial and how
		the government may prosecute individuals that commit commercial.</p>
	</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="lawyerTable">
        ...
        $sql = "SELECT * FROM `lawyerreg` WHERE type = 'commercial lawyer'";
