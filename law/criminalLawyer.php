...
<head>
    ...
    <title>Law &mdash; Criminal Lawyers</title>
...
<!-- Carousel Start  -->
<aside id="fh5co-hero" class="js-fullheight" style="z-index: -1;">
<div class="flexslider js-fullheight">
<ul class="slides">
	<!-- Slide 1 -->
	<li style="background-image:url(./assets/images/crimeban.jpeg);background-size:cover;background-position:center;background-attachment:fixed;position:relative;">
	<div class="overlay-gradient"></div>
		<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			<div class="slider-text-inner">
				<h1 style="font-weight: 600; font-family: sans-serif;">Criminal Lawyers</h1>
...
<div class="container">
	...
	<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
		...
		<p> law concerns the system of legal rules that define what conduct is classified as a criminal and how
		the government may prosecute individuals that commit criminal.</p>
	</div>
	</div>
</div>
<style>
...
.card:hover {
    ...
    box-shadow: 0 10px 20px rgba(0, 0, 0, 0.16), 0 5px 10px rgba(0, 0, 0, 0.12);
}
.btn{
	background: #fff;
...
.card:hover .text-overlay::before {
    opacity: 1; 
}
#filterInput{
...
<div class="container">
    ...
    <div class="col-md-7" style="visibility:hiddden;"></div>
        <div class="col-md-5 searhbar" style="">
            <input type="text" id="filterInput" placeholder="Search by City..." style="width:100%">
    ...
    <div class="row" id="lawyerTable">
        <?php
        include "../admin panel/conn.php";
        error_reporting(E_ALL);
        ini_set('display_errors', 1);
        $sql = "SELECT * FROM `lawyerreg` WHERE type = 'criminal lawyer'";
        ...
        ?>
            <div class="col-sm-3">
                <form action="./lawyerAppointment.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $data["id"]; ?>">
                    <input type="hidden" name="name" value="<?php echo $data["name"]; ?>">
                    <input type="hidden" name="type" value="<?php echo $data["type"]; ?>">
                    <input type="hidden" name="status" value="<?php echo $data["status"]; ?>">
                    <input type="hidden" name="work" value="<?php echo $data["work"]; ?>">
                    <input type="hidden" name="edu" value="<?php echo $data["education"]; ?>">
                    <input type="hidden" name="tel" value="<?php echo $data["contact"]; ?>">
                    <input type="hidden" name="email" value="<?php echo $data["email"]; ?>">
                    <input type="hidden" name="image" value="<?php echo $data["Image"]; ?>">
                    <div class="card">
                        <div class="card-image">
                            <img class="img-responsive" src="../admin panel/<?php echo $data["Image"]; ?>" height="300px">
                            <span class="card-title" style="background-color: rgba(226, 132, 1, 0.4);"><?php echo $data["name"] ?></span>
							<div class="text-overlay"></div> 
                        </div>
                        <div class="card-content" style="display:flex;justify-content:space-between;">
                            <span><?php echo $data["city"] ?></span>
                            <span><button type="submit" name="submit" class="btn" style="border-radius:50%;"><i class="fa fa-check"></i></button> </span>
                        </div>
                    </div>
                </form>
            </div>
...
$(document).ready(function () {
    $("#filterInput").on("keyup", function () {
        ...
        $("#lawyerTable .col-sm-3").filter(function () {
