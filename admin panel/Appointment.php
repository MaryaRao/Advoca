...
<div class="collapse navbar-collapse" id="myNavbar">
    ...
    <div class="bottom-border pb-3">
     ...
     <ul class="navbar-nav flex-column mt-4">
        ...
        <li class="nav-item"><a href="./Appointment.php" class="nav-link text-white p-2 mb-2 current">
...
<div class="container-fluid">
    ...
    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
        <div class="row">
            <div class="col-12">
            <h3 class="text-dark text-center mb-3 heading">Appointment Details:</h3>
<!-- Php Start  -->
<?php
include "conn.php";
...
echo 
    ...
    <tr class='text-light'>
        ...
        <td>".$data[6]."</td>
        <td>".$data[7]."</td>
        <td><a class='btn btn-outline-danger' href='appointDel.php?Id=$data[0]' role='button'><i class='fa-solid fa-trash-can'></i></a></td>
    </tr>";
}
};
?>
