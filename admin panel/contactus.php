...
<div class="collapse navbar-collapse" id="myNavbar">
    ...
    <ul class="navbar-nav flex-column mt-4">
        ...
        <li class="nav-item"><a href="./contactus.php" class="nav-link text-white p-2 mb-2 current">
...
<div class="modal fade" id="sign-out">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <a type="button" href="contactus.php?logout=true" class="btn btn-outline-danger">Yes</a>
        </div>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    ...
    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
        <div class="row">
            <div class="col-12">
            <h3 class="text-dark text-center mb-3 heading">Contact Us Details:</h3>
<!-- Php Start  -->
<?php
include "conn.php";
...
if($totalrows != 0) {
    echo '<table class="table table-dark table-hover text-center table-border">
    <thead>
        <tr class="text-white">
            <th>ID</th>
            <th>NAME</th>
            <th>What Would You Like To</th>
            <th>Phone</th>
            <th>EMAIL</th>
            <th>Area</th>
            <th>Message</th>
...
echo 
    ...
    <tr class='text-light'>
        ...
        <td>".$data[6]."</td>
        <td>".$data[7]."</td>
        <td><a class='btn btn-outline-danger' href='contDel.php?Id=$data[0]' role='button'><i class='fa-solid fa-trash-can'></i></a></td>
    </tr>";
}
};
?>
