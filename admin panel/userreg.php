...
<div class="collapse navbar-collapse" id="myNavbar">
    ...
    <div class="bottom-border pb-3">
     ...
     <li class="nav-item"><a href="./AdminPanel.php" class="nav-link text-white p-2 mb-2">
        ...
        <li class="nav-item"><a href="./userreg.php" class="nav-link text-white p-2 mb-2 current">
...
<div class="container-fluid">
    ...
    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
        <div class="row">
            <div class="col-12">
            <h3 class="text-dark text-center mb-3 heading">User Registration Details:</h3>
<!-- Php Start  -->
<?php
include "conn.php";

$sql = "SELECT * FROM `user_log_sign`";
...
echo 
    ...
    <tr class='text-light'>
        ...
        <td>".$data[2]."</td>
        <td>".$data[3]."</td>
        <td><a class='btn btn-outline-danger' href='userregdel.php?Id=$data[0]' role='button'><i class='fa-solid fa-trash-can'></i></a></td>
    </tr>";
}
};
?>
